      ...
      <div className="bg-gradient-to-t from-purple-400 to-black min-h-screen">
        ...
        <div className="flex justify-center items-center flex-col">
          ...
          <div className="ml-16 mt-5 text-center">
            <p>
              Welcome to Crayo AI customer support! Our intelligent chatbot is
              here to assist you with <br /> any questions or concerns you may
              have. Designed to provide quick and accurate responses, <br />{" "}
              available 24/7.
            </p>
          </div>
          <div className=" mt-10">
